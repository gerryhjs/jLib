...
public class Form extends JFrame {
	...
	public Form() throws IOException, FileNotFoundException {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (vn!=null)
				{
				    ...
				    if (reply==0)
				    {
				    	...
				    	Notice("Remove Vertex"+vn.getName(),true);
				    	refresh();
				    }
				}
				EdgeNode en=map.getEdge(list.getSelectedItem());
		...
		btnDijkstra.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				long len=map.Dijkstra(map.getVertex("A"), map.getVertex("F"));
				 Date end = new Date();
					Notice(map.VertexArrayToPrint(map.route),true);	
...
*/
		...
		btnMap1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				lab=1;
				if (loadData()) 	
					Notice("LoadData Finished.",true); 
				else 
					Notice("LoadData Failed.",true);
				refresh();
			}
		});
		...
		initData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				SortArray.list=list;
				Notice("Create the sort array.",true);
				Notice("Reset Sort data",true);
				//SortArray.recover();
		...
		btnInsertSort.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				 ...
				 Notice("Start Sorting",true);
					...
					// Notice(String.valueOf(reply),true);
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						...
						.addComponent(resultLabel, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 241, Short.MAX_VALUE))
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
							.addGroup(gl_contentPane.createSequentialGroup()
								.addGap(28)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
									.addComponent(mainLabel, GroupLayout.PREFERRED_SIZE, 333, GroupLayout.PREFERRED_SIZE)
									.addGroup(gl_contentPane.createSequentialGroup()
	...
	public void Notice(String msg,boolean broadcast)
	{
		DateFormat df= new SimpleDateFormat("HH:mm:ss.SSS"); 
		if (broadcast)  mainLabel.setText("<html>"+df.format(new Date())+"-"+msg+"<br>"+mainLabel.getText());
